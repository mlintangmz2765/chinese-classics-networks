...
TOTAL_CHAPTERS = 100
BASE_URL = "https://zh.wikisource.org/wiki/西遊記/第{:03d}回"
OUTPUT_FILE = "Xiyou_Ji_Raw.txt"
...
def main():
    ...
    print(f"Starting scraping {TOTAL_CHAPTERS} chapters of Xi You Ji (Journey to the West) from Wikisource...")
    ...
    print(f"Done! All text for Xi You Ji saved to {OUTPUT_FILE}")
