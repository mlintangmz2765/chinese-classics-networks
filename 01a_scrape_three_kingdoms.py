...
TOTAL_CHAPTERS = 120
BASE_URL = "https://zh.wikisource.org/wiki/三國演義/第{:03d}回"
OUTPUT_FILE = "Sanguo_Yanyi_Raw.txt"
...
def main():
    if os.path.exists(OUTPUT_FILE):
        ...
        print("Old file Sanguo_Yanyi_Raw.txt deleted, restarting...")
        
    print(f"Starting scraping {TOTAL_CHAPTERS} chapters from Wikisource...")
    ...
    for i in range(1, TOTAL_CHAPTERS + 1):
        ...
        if content:
            ...
            print(f"Failed to process Chapter {i}.")
