...
TOTAL_CHAPTERS = 120
BASE_URL = "https://zh.wikisource.org/wiki/紅樓夢/第{:03d}回"
OUTPUT_FILE = "Honglou_Meng_Raw.txt"
...
def main():
    ...
    print(f"Starting scraping {TOTAL_CHAPTERS} chapters of Hong Lou Meng (Dream of the Red Chamber) from Wikisource...")
    ...
    print(f"Done! All text for Hong Lou Meng saved to {OUTPUT_FILE}")
